...
;; Given: a person 
;; Returns: image scaled as per the height of the person with 
;; the name printed below it
;; Examples:
;; (person-image (make-person "Anuj" "Thakur" 21 200 100)) => 


(define (human-shape fst lst hgt wgt) (above (scale (/ hgt 100) (above (circle 20 "outline" "grey")
       (beside/align "top"
       ...
       (beside
        ...
        (rectangle 15 40 "solid" "yellow"))))
       (text (string-append fst " " lst) 24 "olive")
       ))  


(define (person-image p) (human-shape (person-first-name p) 
                        (person-last-name p) (person-height p) (person-weight p)))
