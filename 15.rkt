...
;; Interpretation:
;; the constructor creates a struct with the following fields:
;; id is the id number of the student, the id is a Non negative number
;; name is the name of the student, the name is a string
;; major is the major of the student, the major is a string
